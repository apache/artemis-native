...
public class IOCBInit {
    ...
    public static final MemoryLayout IOCB_LAYOUT = MemoryLayout.structLayout(
            ValueLayout.JAVA_LONG.withName("aio_data"),
            ValueLayout.JAVA_INT.withName("aio_key"),
            ValueLayout.JAVA_INT.withName("aio_rw_flags"),
            ValueLayout.JAVA_SHORT.withName("aio_lio_opcode"),
            ValueLayout.JAVA_SHORT.withName("aio_reqprio"),
            ValueLayout.JAVA_INT.withName("aio_fildes"),
            ValueLayout.JAVA_LONG.withName("aio_buf"),
            ValueLayout.JAVA_LONG.withName("aio_nbytes"),
            ValueLayout.JAVA_LONG.withName("aio_offset"),
            ValueLayout.JAVA_LONG.withName("aio_reserved2"),
            ValueLayout.JAVA_INT.withName("aio_flags"),
            ValueLayout.JAVA_INT.withName("aio_resfd")
    ).withByteAlignment(8).withName("iocb");
